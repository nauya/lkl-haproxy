...
```bash
# for centos
bash <(curl -Ls https://github.com/nauya/lkl-haproxy/raw/master/lkl-haproxy-centos-nocheckvirt.sh)

# for debian
bash <(curl -Ls https://github.com/nauya/lkl-haproxy/raw/master/lkl-haproxy-debian-nocheckvirt.sh)
